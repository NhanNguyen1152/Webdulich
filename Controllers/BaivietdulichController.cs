...
namespace DL.Controllers
{
    public class BaivietdulichController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["BvdlMaqt"] = new SelectList(_context.Quantri, "QtEmail", "QtEmail");
        ...
        public async Task<IActionResult> Create([Bind("BvdlMa,BvdlNoidung,BvdlMaqt,BvdlMadddl,BvdlMatt,BvdlMahinhanh,BvdlMabdg")] Baivietdulich baivietdulich)
        {
            ...
            ViewData["BvdlMaqt"] = new SelectList(_context.Quantri, "QtEmail", "QtEmail", baivietdulich.BvdlMaqt);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("BvdlMa,BvdlNoidung,BvdlMaqt,BvdlMadddl,BvdlMatt,BvdlMahinhanh,BvdlMabdg")] Baivietdulich baivietdulich)
        {
